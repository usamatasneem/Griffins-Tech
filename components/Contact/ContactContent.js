      ...
      <div className="container">
        <div className="row text-center">
          <div className="col-md-6 col-xl-4">
            <ContactCard
              icon={<AiTwotonePhone />}
              contentOne={<a href="tel:+923139133135">+92 313 9133135</a>}
          ...
          <div className="col-md-6 col-xl-4">
            <ContactCard
              icon={<FaEnvelope />}
              contentOne={
                <a href="mailto:info@griffinstech.pk">info@griffinstech.pk</a>
              }
          ...
          <div className="col-md-6 col-xl-4">
            <ContactCard
              icon={<FaMapMarkerAlt />}
              contentOne={
                <a href="https://maps.app.goo.gl/67Cs2C8qiDcCkXk27">
                  Tench Road,Opp to CMH Hospital, Rawalpindi.
                </a>
              }
